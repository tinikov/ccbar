...
if [ $# != 4 ]; then
	echo -e "\033[1mUSAGE:\033[0m $(basename $0) [XYZSIZE] [TSIZE] [X4PT] [NCONF]"
	exit 1
fi
...
for ((i = 0; i < $NCONF; i += 1)); do
	...
	echo -e "Conducting KS(TD)-method for \033[1;35m$BINNAME/$X4PT\033[0m"
	echo " "

	O_DIR=$ROOT/result/$X4PT/FKS-rec-TD/$BINNAME
